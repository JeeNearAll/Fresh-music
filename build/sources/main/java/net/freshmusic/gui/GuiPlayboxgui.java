...
public class GuiPlayboxgui extends ElementsFreshmusic.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiPlayboxgui(ElementsFreshmusic instance) {
		super(instance, 5);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				Freshmusic.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("freshmusic:textures/playboxgui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Playbox", 61, 11, -1);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 61, this.guiTop + 29, 100, 20, "play track"));
			this.buttonList.add(new GuiButton(1, this.guiLeft + 61, this.guiTop + 56, 90, 20, "stop play"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			Freshmusic.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
